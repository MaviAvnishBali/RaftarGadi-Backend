...
class AdminApi {
  ...
  Future<Response<void>> adminControllerActivateUser({ 
    required String id,
    ...
    final _path = r'/api/v1/admin/users/{id}/activate'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> adminControllerDeactivateUser({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/admin/users/{id}/deactivate'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> adminControllerGetAuditLogs({ 
    String? page,
    String? limit,
    String? actorId,
    String? action,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (entityId != null) r'entityId': encodeQueryParameter(_serializers, entityId, const FullType(String)),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> adminControllerGetOverview({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<JsonObject>>> reportsControllerGetBookingTrends({ 
    String? from,
    String? to,
    String? interval,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/reports/booking-trends';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> reportsControllerGetDashboardStats({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/reports/dashboard';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<JsonObject>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<JsonObject>>> reportsControllerGetDriverPerformanceReport({ 
    String? from,
    String? to,
    String? interval,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/reports/driver-performance';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> reportsControllerGetRevenueReport({ 
    String? from,
    String? to,
    String? interval,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/reports/revenue';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
