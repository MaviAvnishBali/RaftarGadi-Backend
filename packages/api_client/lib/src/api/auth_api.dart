...
class AuthApi {
  ...
  Future<Response<void>> authControllerGetMe({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerLogoutAll({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/logout-all';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerRefreshTokens({ 
    required RefreshTokenDto refreshTokenDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> authControllerSendOtp({ 
    required SendOtpDto sendOtpDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/auth/send-otp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SendOtpDto);
      _bodyData = _serializers.serialize(sendOtpDto, specifiedType: _type);
  ...
  Future<Response<void>> authControllerVerifyOtp({ 
    ...
    final _path = r'/api/v1/auth/verify-otp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
