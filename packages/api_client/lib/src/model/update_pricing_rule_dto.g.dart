...
part of 'update_pricing_rule_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$UpdatePricingRuleDto extends UpdatePricingRuleDto {
  @override
  ...
  factory _$UpdatePricingRuleDto([
    void Function(UpdatePricingRuleDtoBuilder)? updates,
  ]) => (UpdatePricingRuleDtoBuilder()..update(updates))._build();

  _$UpdatePricingRuleDto._({
    this.vehicleTypeId,
    this.city,
    this.baseFare,
    this.perKmCharge,
  ...
  @override
  UpdatePricingRuleDto rebuild(
    void Function(UpdatePricingRuleDtoBuilder) updates,
  ) => (toBuilder()..update(updates)).build();

  @override
  UpdatePricingRuleDtoBuilder toBuilder() =>
      UpdatePricingRuleDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is UpdatePricingRuleDto &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'UpdatePricingRuleDto')
...
class UpdatePricingRuleDtoBuilder
    implements Builder<UpdatePricingRuleDto, UpdatePricingRuleDtoBuilder> {
  _$UpdatePricingRuleDto? _$v;
  ...
  UpdatePricingRuleDtoBuilder() {
    UpdatePricingRuleDto._defaults(this);
  }

  UpdatePricingRuleDtoBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(UpdatePricingRuleDto other) {
    _$v = other as _$UpdatePricingRuleDto;
  }

  @override
  void update(void Function(UpdatePricingRuleDtoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  UpdatePricingRuleDto build() => _build();

  _$UpdatePricingRuleDto _build() {
    final _$result =
        _$v ??
        _$UpdatePricingRuleDto._(
